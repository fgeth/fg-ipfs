...
import (
	...
	version "github.com/fgeth/fg-ipfs"
	config "github.com/fgeth/fg-ipfs-config"
	cserial "github.com/fgeth/fg-ipfs-config/serialize"
	utilmain "github.com/fgeth/fg-ipfs/cmd/ipfs/util"
	oldcmds "github.com/fgeth/fg-ipfs/commands"
	"github.com/fgeth/fg-ipfs/core"
	commands "github.com/fgeth/fg-ipfs/core/commands"
	"github.com/fgeth/fg-ipfs/core/coreapi"
	corehttp "github.com/fgeth/fg-ipfs/core/corehttp"
	corerepo "github.com/fgeth/fg-ipfs/core/corerepo"
	libp2p "github.com/fgeth/fg-ipfs/core/node/libp2p"
	nodeMount "github.com/fgeth/fg-ipfs/fuse/node"
	fsrepo "github.com/fgeth/fg-ipfs/repo/fsrepo"
	"github.com/fgeth/fg-ipfs/repo/fsrepo/migrations"
	"github.com/fgeth/fg-ipfs/repo/fsrepo/migrations/ipfsfetcher"
...
func serveHTTPGateway(req *cmds.Request, cctx *oldcmds.Context) (<-chan error, error) {
	...
	if len(cfg.Gateway.PathPrefixes) > 0 {
		log.Error("Support for X-Ipfs-Gateway-Prefix and Gateway.PathPrefixes is deprecated and will be removed in the next release. Please comment on the issue if you're using this feature: https://github.com/fgeth/fg-ipfs/issues/7702")
	}
