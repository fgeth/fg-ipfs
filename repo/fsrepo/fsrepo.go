...
import (
	...
	keystore "github.com/fgeth/fg-ipfs-keystore"
	repo "github.com/fgeth/fg-ipfs/repo"
	"github.com/fgeth/fg-ipfs/repo/common"
	dir "github.com/fgeth/fg-ipfs/thirdparty/dir"

	ds "github.com/ipfs/go-datastore"
	measure "github.com/ipfs/go-ds-measure"
	lockfile "github.com/ipfs/go-fs-lock"
	config "github.com/fgeth/fg-ipfs-config"
	serialize "github.com/fgeth/fg-ipfs-config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/fgeth/fg-ipfs/blob/master/docs/datastores.md#flatfs.")
	}
