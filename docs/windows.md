...
go get -u github.com/fgeth/fg-ipfs
...
|`go get -u github.com/fgeth/fg-ipfs`       |Fetch / Update `go-ipfs` source|
...
|`mkdir %GOPATH%\src\github.com\ipfs`<br/>`cd %GOPATH%\src\github.com\ipfs`<br/>`git clone https://github.com/fgeth/fg-ipfs.git`       |Fetch / Update `go-ipfs` source|
|`cd %GOPATH%\src\github.com\ipfs\go-ipfs` |Change to `go-ipfs` source directory|
|`make install`                            |Build and install to `%GOPATH%\bin\ipfs.exe`|
|`%GOPATH%\bin\ipfs.exe version --all`     |Test the built binary|
...
```
git clone https://github.com/fgeth/fg-ipfs %GOPATH%/src/github.com/fgeth/fg-ipfs
cd %GOPATH%/src/github.com/fgeth/fg-ipfs/cmd/ipfs
```
...
```
go install -ldflags="-X "github.com/fgeth/fg-ipfs".CurrentCommit=%SHA%"
%GOPATH%\bin\ipfs.exe version --all
```
...
If you encounter a bug with `go-ipfs` itself (not related to building) please use the [issue tracker](https://github.com/fgeth/fg-ipfs/issues) to report it.
