...
import (
	...
	assets "github.com/fgeth/fg-ipfs/assets"
...
func (i *gatewayHandler) getOrHeadHandler(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: this feature is deprecated and will be removed  (https://github.com/fgeth/fg-ipfs/issues/7702)
	prefix := ""
	...
	if r.Header.Get("Service-Worker") == "script" {
		...
		// https://github.com/fgeth/fg-ipfs/issues/4025
	...
	// and https://github.com/fgeth/fg-ipfs/issues/7164
	...
	// https://github.com/fgeth/fg-ipfs/issues/1365
...
func (i *gatewayHandler) serveFile(w http.ResponseWriter, req *http.Request, name string, modtime time.Time, file files.File) {
	...
	if _, isSymlink := file.(*files.Symlink); isSymlink {
		...
		if ctype == "" {
			...
			// Fixes https://github.com/fgeth/fg-ipfs/issues/7252
		...
		//
		// Fixes https://github.com/fgeth/fg-ipfs/issues/2203
