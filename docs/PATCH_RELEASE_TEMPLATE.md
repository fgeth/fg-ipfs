...
- [ ] cut a release on [github](https://github.com/fgeth/fg-ipfs/releases) and upload the result of the ipfs/distributions build in the previous step.
...
- [ ] Release published
  ...
  - [ ] to [github](https://github.com/fgeth/fg-ipfs/releases)
